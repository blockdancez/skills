...
- 如果出现 Google 账号选择器，默认选择第一个可见的个人 Google 账号。不要选择明显属于公司、学校或管理型组织的账号；如果无法判断是否为个人账号，停止并询问用户。
...
遇到付费、敏感个人数据、非项目文件、浏览器权限、非 Google 账号创建，或 listing 之外的权限授权时，提交前必须停止。

## 标签页清理

按照 Chrome 插件说明清理标签页。只有当用户需要接手阻塞流程或查看已提交 listing 时，才保留标签页。
